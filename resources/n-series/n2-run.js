...
const SCRATCH = '/tmp/claude-0/-home-user-sergeant-rs/fff58c4e-2990-5de3-a53f-f5e2c669c45f/scratchpad/n2-run'
...
3. Copy the run's deliverables OUT of the worktree into ${REPO}/docs/gauntlet/runs/n2-run1/: every .sergeant/workflows/repo-to-icm/*/output/ artifact (preserving stage structure), the generated draft packages from the worktree's .sergeant/drafts/workflows/ (if 60-draft placed them there), plus a run-manifest.md you write: subject SHA ${setup.subject_sha}, work id, final state, stage timings table, artifact inventory, ambiguity roll-up (read each stage's outputs for AMBIGUOUS markers).
