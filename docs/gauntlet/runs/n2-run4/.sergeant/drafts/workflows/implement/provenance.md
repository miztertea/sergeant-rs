...
- Primary behavior_id: `BU-0974` (`.agents/skills/implement/SKILL.md (.agents/skills/implement/SKILL.md L9-9)`)
- Stage-context attachments: `BU-0975`

### `02-review-implementation`

- Primary behavior_id: `BU-0976` (`.agents/skills/implement/SKILL.md (.agents/skills/implement/SKILL.md L13-13)`)

### `03-commit-implementation`

- Primary behavior_id: `BU-0977` (`.agents/skills/implement/SKILL.md (.agents/skills/implement/SKILL.md L15-15)`)
