# Output -- `08-reconcile-and-deliver`
...
**Expected artifact (draft inference from `BU-0035`, subject to promotion review):** a durable record of this stage's outcome -- cleanup runs only after terminal state and evidence preservation are verified.
