...
| Container resets | wipe installed tools and `target/` (~10 min DuckDB rebuild); repo restored from remote is the only safe state | three resets in one S-series day; docs/DEVELOPMENT.md ops section |
