...
**Expected artifact:** a record of — Owning repos, absolute paths, clone state, roles/groups, and the layered instruction set are recorded as the governing context.
