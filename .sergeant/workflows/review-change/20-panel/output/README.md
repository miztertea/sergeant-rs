...
**Expected artifact:** `findings.md` — the typed finding table, every row
at `status: raised`, plus the four seats' verbatim reports beneath it,
tagged by axis; any missing axis named explicitly.
