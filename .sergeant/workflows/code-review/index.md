...
`sergeant-rs-workspace/knowledge/evidence/gauntlet/promoted-provenance/code-review.md` for the prior revision's
full behavior-unit citations and promotion record, and
`sergeant-rs-workspace/knowledge/evidence/gauntlet/runs/icm-r2/code-review/adjudication-draft.md` for this
