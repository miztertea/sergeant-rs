# Output — `10-reproduce-and-minimize`
...
**Expected artifact:** a record of the minimized repro and what was cut to
reach it — or, on the hard-gate failure path, what was tried and why
reproduction could not be achieved.
