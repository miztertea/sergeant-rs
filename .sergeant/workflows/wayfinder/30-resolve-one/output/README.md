...
**Expected artifact:** a record of — Claim, resolve by type, record the answer as a resolution and a one-line pointer; at most one non-research ticket per session.
