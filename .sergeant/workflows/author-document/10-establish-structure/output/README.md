...
**Expected artifact:** `structure.md` — the outline, the named audience
and purpose, and (where the `record-decisions` profile applies) the
transcribed decisions with any logged gaps.
