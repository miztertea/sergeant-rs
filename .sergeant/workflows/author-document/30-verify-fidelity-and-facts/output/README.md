# Output — `30-verify-fidelity-and-facts`
...
**Expected artifact:** `verification.md` — fidelity findings (top-
weighted), fact-check findings with source citations, any stated gap for
an unverifiable source, and internal-consistency findings.
