...
- Deriving the plan (repos, dependency order, branch, backend) from a td task or a free-form brief.

### J1 — local choices allowed
- None beyond ordinary tool mechanics.

### J0 — must become `needs_input`
- The stated plan is not confirmed as accurate before proceeding — explicit confirmation is required, not an inferred go-ahead.
