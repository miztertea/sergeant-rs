...
**Expected artifact:** a record of — One canonical intent revision exists and is written identically to fleet state and every selected work surface.
