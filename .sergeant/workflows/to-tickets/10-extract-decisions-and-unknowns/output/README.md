# Output — `10-extract-decisions-and-unknowns`
...
**Expected artifact:** a record of — An investigation ticket is created only for a genuinely blocking unknown, naming the exact artifact it must produce.
