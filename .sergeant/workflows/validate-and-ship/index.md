...
`validate-and-ship`, `sergeant-rs-workspace/knowledge/evidence/gauntlet/contracts/N1.md`) that is the single
...
`sergeant-rs-workspace/knowledge/evidence/gauntlet/promoted-provenance/validate-and-ship.md`; the curation act
