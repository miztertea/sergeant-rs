...
### Decision evidence
The transport decision and its consent record are the audit log — the append-only launch log is this stage's own decision-evidence surface, not a separate file.
