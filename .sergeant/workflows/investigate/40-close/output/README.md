...
**Expected artifact:** `close-packet.md` — the answer (or honest "not yet
known"), confidence, contradictory evidence found, remaining unknowns,
and recommended next intents.
