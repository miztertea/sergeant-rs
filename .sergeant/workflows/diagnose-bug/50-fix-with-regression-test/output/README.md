# Output — `50-fix-with-regression-test`
...
**Expected artifact:** a record of — A test exists at a correct seam before the fix, or the seam's absence is recorded as the finding.
