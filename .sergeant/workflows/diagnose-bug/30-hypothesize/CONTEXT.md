...
- Proceeding without the user's re-ranking if the user is unavailable — an explicitly named non-blocking exception, not a J0 escalation.

### J1 — local choices allowed
- None beyond ordinary tool mechanics.

### J0 — must become `needs_input`
- A hypothesis that cannot be stated as a falsifiable prediction — discard or sharpen it before showing the list, rather than presenting a vibe as a hypothesis.

### Completion boundary
This stage may complete only when 3-5 ranked, falsifiable hypotheses have been shown to the user (or, if unavailable, recorded for later re-ranking).
