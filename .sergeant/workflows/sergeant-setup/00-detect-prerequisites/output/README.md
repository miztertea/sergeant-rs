# Output — `00-detect-prerequisites`
...
**Expected artifact:** a record of — Every checked tool is classified present / installable / unsupported; required gaps stop the run unless the user accepts the risk.
