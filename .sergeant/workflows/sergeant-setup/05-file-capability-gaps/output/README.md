# Output — `05-file-capability-gaps`
...
**Expected artifact:** a record of — Each unsupported capability becomes an approved tracked issue, or is reported as an unfilled gap.
