# Output — `40-define-delivery-gates`
...
**Expected artifact:** a record of — Per-repo gate: owning task, fixed point, native commands, review sources, PR/deploy order, outstanding decisions.
