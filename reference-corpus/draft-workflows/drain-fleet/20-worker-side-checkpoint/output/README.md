# Output — `20-worker-side-checkpoint`
...
**Expected artifact:** a record of — Idempotent drain detection; publish handoff and settle the lease before terminating anything.
