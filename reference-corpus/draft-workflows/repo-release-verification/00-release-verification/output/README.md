# Output — `00-release-verification`
...
**Expected artifact:** a record of — The drain suite must pass before every push; missing tooling fails closed rather than silently skipping.
