...
**Expected artifact:** a record of — Acknowledgement is verified, re-verified under lock immediately before deletion, and a terminal seal is written.
