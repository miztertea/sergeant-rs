...
**Expected artifact:** a record of — Every targeted repo is safely terminal and the owning task is verifiably closed; "not closed" is distinguished from "could not be looked up".
