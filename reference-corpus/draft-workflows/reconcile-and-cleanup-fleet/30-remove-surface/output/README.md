...
**Expected artifact:** a record of — A resumable cleanup-phase record is published before and after; no process runs with its cwd inside the surface being removed.
