...
**Expected artifact:** a record of — Each finding is routed with a dedup marker scoped to axis+source+id+parent+branch; a divergent stored body is refused untouched.
