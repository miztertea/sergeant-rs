...
**Expected artifact:** a record of — A sanitized copy is written to durable storage before any external side effect; the failure diagnostic names the retryable next action.
