# Output — `10-resolve-source-conflicts`
...
**Expected artifact:** a record of — Where sources disagree, the answer follows the fixed precedence and the mismatch is reported as tracked work.
