...
**Expected artifact:** a record of — The question is bound to one primary document, which is read before any broad search; a missing primary document stops the run with its expected path.
