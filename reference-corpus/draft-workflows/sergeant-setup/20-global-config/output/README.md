...
**Expected artifact:** a record of — One machine-wide `dev_root` exists and parses; an existing file is never overwritten without backup + diff + confirmation.
