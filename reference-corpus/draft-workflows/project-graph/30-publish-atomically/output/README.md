...
**Expected artifact:** a record of — Readers see the complete old or complete new graph, never a torn state; a failed swap leaves the previous output valid.
