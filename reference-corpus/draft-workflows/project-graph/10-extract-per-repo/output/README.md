...
**Expected artifact:** a record of — Per-repo extraction completed, with in-source output staged out of the way and code-only fallback when no LLM key exists.
