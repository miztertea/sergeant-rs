...
**Expected artifact:** a record of — A bounded, constant-size, versioned, strictly read-only snapshot; `busy:true` only with a verified witness, otherwise `busy:null`.
