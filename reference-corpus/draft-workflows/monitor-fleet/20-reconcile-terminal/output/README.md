...
**Expected artifact:** a record of — A `done` status with an empty result is refused as completion and marked orphaned; terminal recycling is identity-bound and settles the lease first.
