# Output — `10-acquire-launch-reservation`
...
**Expected artifact:** a record of — An identity-checked reservation for the exact task/repo pair; concurrent attempts fail closed until the owner exits or stale ownership is proven.
