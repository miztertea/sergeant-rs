...
**Expected artifact:** a record of — A published readiness marker asserts the exact intent revision, the exact reviewed head, and an explicit pass on every review axis; any mismatch refuses with its own reason.
