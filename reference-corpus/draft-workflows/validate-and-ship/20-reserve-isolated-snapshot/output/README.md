# Output — `20-reserve-isolated-snapshot`
...
**Expected artifact:** a record of — Validation runs against an isolated snapshot pinned at the reviewed commit with a clean tree, re-verified immediately before invocation.
