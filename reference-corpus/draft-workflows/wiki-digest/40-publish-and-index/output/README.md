...
**Expected artifact:** a record of — The page exists and is linked, or the page is kept, its path reported, and the digest marked incomplete; an existing page is never overwritten with less information.
