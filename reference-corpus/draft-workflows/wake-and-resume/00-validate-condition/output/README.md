...
**Expected artifact:** a record of — A strict field/value allowlist is enforced — no dash-leading values, secret-shaped names screened — before evaluation.
