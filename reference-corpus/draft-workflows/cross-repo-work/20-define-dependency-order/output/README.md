# Output — `20-define-dependency-order`
...
**Expected artifact:** a record of — An acyclic edge set in prerequisite>dependent form; cycles broken by a named contract artifact.
