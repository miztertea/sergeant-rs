# Output — `30-inspect-repository-state`
...
**Expected artifact:** a record of — Non-main branches, uncommitted changes, ahead/behind, worktrees, preserved workers recorded without mutating anything.
