...
| `m5_projections.rs:2602` | 30 s | *asserted* rebuild time for 16,000 events — a performance bound, not a wait; see "Asserted performance bounds" above, which is the class it belongs to | **1.17 s** (13.7k events/s) | **25.6×** — the most generous bound in the suite, as S0 estimated (~27×) |
